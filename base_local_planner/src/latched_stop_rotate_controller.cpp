...
bool LatchedStopRotateController::isPositionReached(LocalPlannerUtil* planner_util,
  ...
  ROS_INFO_STREAM("LatchedStopRotateController::isPositionReached: xy_goal_tolerance: "<<xy_goal_tolerance<<", dist: "<<base_local_planner::getGoalPositionDistance(global_pose, goal_x, goal_y));
